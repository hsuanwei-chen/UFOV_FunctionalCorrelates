...
src_fold <- "T:/Stacy/Scans/BRAINY/1_Derivatives/UFOV_FunctionalCorrelates/ConnectivityMatrices_Schaefer2018_400Parcels_7Networks/FisherZ"
dest_fold <- "T:/Stacy/Scans/BRAINY/1_Derivatives/UFOV_FunctionalCorrelates/ConnectivityMatrices_Schaefer2018_400Parcels_7Networks/FisherZ_heatmap"
group_summary_fname <- "T:/Stacy/Scans/BRAINY/1_Derivatives/UFOV_FunctionalCorrelates/ConnectivityMatrices_Schaefer2018_400Parcels_7Networks/FisherZ_group_summary.csv"
...
for(row in 1:nrow(sub_list)){
  ...
  plot_title <- paste(sub_list$subject_id[row], sub_list$sess_date[row], sub_list$task_dir[row],
                      "Schaefer400 7Networks FC matrix")
