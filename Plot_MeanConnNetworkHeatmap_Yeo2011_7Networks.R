...
plot_title <- paste("Entire Sample Yeo2011 7Networks Mean FC matrix")
...
col_fun = colorRamp2(seq(0.2, 1.4, length = 4), 
                     c("blue", "lightgreen", "yellow", "red"))
plot_title <- paste("mTBI Yeo2011 7Networks Mean FC matrix")
...
col_fun = colorRamp2(seq(0.2, 1.4, length = 4), 
                     c("blue", "lightgreen", "yellow", "red"))
plot_title <- paste("Control Yeo2011 7Networks Mean FC matrix")
